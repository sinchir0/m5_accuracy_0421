...
###FamilySize_test
class FamilySize_test(Feature):
    def create_features(self):
        self.train['FamilySize_test'] = train['Parch'] + train['SibSp'] + 2
        self.test['FamilySize_test'] = test['Parch'] + test['SibSp'] + 2
...
if __name__ == '__main__':
    ...
    test = pd.read_pickle('./data/input/test.pkl')

    # globals = global変数を全部渡す
    # args.force = コマンドに-fを付与してるっぽい？
